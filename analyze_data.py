...
class StockAnalyzer:
    ...
    def analyze_all(self):
        ...
        for stock in self.configuration.get_monitored_stocks():
            ...
            a = sma()
            # a.calculate_sell_buy_points(25, 200, history_values, 1000)
            # print("25,200, Given 10000 return is ", a.calculate_return(history_values, 10000))
            # a.calculate_sell_buy_points(25, 50, history_values, 1000)
            # print("25, 50 Given 10000 return is ", a.calculate_return(history_values, 10000))
            # a.calculate_sell_buy_points(12, 30, history_values, 1000)
            # print("12, 30 Given 10000 return is ", a.calculate_return(history_values, 10000))
            a.find_best_parameters(history_values, 10000)
